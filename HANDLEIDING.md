...
**Een nieuwe versie installeren.** Download het nieuwe archief (zelfde knop). Open in de instellingen onder **Skills** de fiche van de skill, menu **⋮** › **Verwijderen**, en herhaal daarna de stappen 3 tot 5. Gebruik « Vervangen » (« Replace ») niet: bij onze tests (september 2026) meldt de fiche een update maar blijft de oude inhoud staan. Om de geïnstalleerde versie te controleren, opent u het tabblad **Inhoud** van de fiche, bestand `SKILL.md`: de versie staat onder de titel (de vermelding « v1 » op de fiche is een teller van de app). Ze staat ook aan het einde van elk verslag.
